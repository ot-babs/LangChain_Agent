...
def scrape_user_tweets(username, num_tweets=5):
    """
    Scrapes a Twitter users original tweets (i.e., not retweets or replies) and returns them as a list of dictionaries.
...
if __name__ == "__main__":
    print(scrape_user_tweets(username="ot_babs"))
